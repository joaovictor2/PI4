    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#med">Cadastro Medico</a>
          </li>
          <li class="nav-item">
  ...
  <header class="masthead">
    ...
    <section id="about" class="content-section text-center">
      <div class="container">
        ...
        <!-- Cadastro Medico Section -->
        <section id="med" class="download-section content-section text-center">
...
<?php
  ...
  if( isset($_GET["id"])){
    ...
    $medico = $MedModel->consultarPorId($_GET["id"]);
...
?>
          ...
          <?php $conectar = mysqli_connect("localhost","root","","projinteg") or die ("Erro na conexão com o Banco de Dados");
          mysqli_query($conectar, 'SET NAMES utf8');

          $sql = "SELECT a.IdEspecialidade, a.Descricao FROM Especialidade as a";
            ...
            <form method="post" id="formmed" action="/projinteg/controller/MedController.php?acao=<?=$acao?>">   
              ...
              <div class="row">
                <div class="form-group col-8">
                  ...
                  <input id="nome"   type="text" name="nome"   value="<?=$Nome?>" class="form-control" > 
                  <label for="Nome">Nome:</label>
                </div>

                 <div class="form-group col-8">
                                  
                  <input id="CRM"    type="text" name="CRM"    value="<?=$CRM?>" class="form-control" >
                ...
                <div class="form-group col-4">
                  ...
                  <select class="form-control" name="IdEspecialidade">
                    ...
                    while($row = $result->fetch_assoc()){
                      ...
                      if($row[IdEspecialidade] == $IdEspecialidade){
                        echo '<option selected value='.$row[IdEspecialidade].' >'.$row[Descricao].'</option>';
                      } else{
    ...
    $("#formmed").submit(function(event) {
       event.preventDefault();

       $.ajax({
        url: $("#formmed").attr("action"),
        method: $("#formmed").attr("method"),
