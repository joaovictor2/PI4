			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 mx-auto">
						...
						<p class="intro-text">Frase de Efeito.
							<br>Created by Us.</p>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 mx-auto">
						...
						<p>Nosso produto visa sanar as dúvidas da sociedade sobre sintomas e prováveis doenças, visto que buscas aleatórias nem sempre retornam resultados confiáveis.
						</p>
						<p>
							“O que eu tenho?” entra no mercado como uma plataforma que tem como principal objetivo apresentar um pré-diagnóstico e um médico responsável pelo tratamento.
						</p>
					</div>
				</div>
		...
		<section id="diagnostico" class="download-section content-section text-center">
			<div class="container">
				<div class="col-lg-12 mx-auto">
					...
					<div class="card-panel">
						...
						<form method="post" id="formsintoma" action="/projinteg/controller/PiController.php?acao=<?=$acao?>">
							<div class="container">
								<div class="row">
									<div class="col">
								...
								<ul class="list-inline banner-social-buttons">
									<li class="list-inline-item">
										<button class="btn btn-default btn-lg" type="submit" id="analisar">
											<span class="network-name">Analisar</span>
										</button>
									</li>
									<li class="list-inline-item">
										<button class="btn btn-default btn-lg" type="button" id="analisar">
			...
			<section id="medico" class="content-section text-center">
				...
				<script type="text/javascript">
					...
					("#formsintoma").on("submit" ,function(event) {
